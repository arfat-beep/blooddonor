...
if (isset($_POST['submit'])) {
		...
		if(isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city)){
			...
			$sql = "UPDATE donor SET `name`='$name', `gender`='$gender',
			 `email`='$email', `city`='$city', `dob`='$dob', `contact`='$contact', `blood_group`='$blood_group' WHERE id =".$_SESSION['user_id'];
...
<?php
	...
	if(isset($_POST['update_pass'])){
		...
		if(isset($password)){
			$sql = "UPDATE donor SET  pass = '$password' WHERE id = '$userID'";
		if(mysqli_query($connection,$sql)){
			...
			<div class="panel panel-default" style="padding: 20px;">
				...
				<form class="form-group" action="" method="post">
					<div class="form-group">
						...
						<input type="text" name="name" id="fullname" required pattern="[A-Za-z/\s]+"
					...
					<div class="form-inline">
						...
						<select class="form-control demo-default" id="date" name="day" style="margin-bottom:10px;"
							...
							<?php if(isset($date[2])) echo '<option value="'.$date[2].'" selected>'.$date[2].'</option>'; ?>
						...
						<select class="form-control demo-default" name="month" id="month" style="margin-bottom:10px;"
							required>
							<?php if(isset($date[1])) echo '<option value="'.$date[1].'" selected>'.$date[1].'</option>'; ?>
						...
						<select class="form-control demo-default" id="year" name="year" style="margin-bottom:10px;"
							...
							<?php if(isset($date[0])) echo '<option value="'.$date[0].'" selected>'.$date[0].'</option>'; ?>
					...
					<div class="form-group">
						...
						<input type="text" name="contact_no" placeholder="01********" class="form-control" required
